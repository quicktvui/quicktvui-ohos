...
REGISTER_OH_NAPI("Runtime", "Runtime_BindNativeBizView", BindNativeBizView)
REGISTER_OH_NAPI("Runtime", "Runtime_UnbindNativeBizView", UnbindNativeBizView)
REGISTER_OH_NAPI("Runtime", "Runtime_OnHippyRootViewReady", OnHippyRootViewReady)
REGISTER_OH_NAPI("Runtime", "Runtime_TestDestroy", TestDestroy)
