...
```
hdc shell aa start -b com.extscreen.runtime -a EntryAbility -U "esapp://es.com.elsbharmony.tv?from=cmd"
...
```
hdc shell aa start -b com.extscreen.runtime -a EntryAbility -U "esapp://es.com.elsbharmony.tv/0.0.2?from=cmd&uri=http%3A%2F%2Ftest-api.extscreen.com%2Fextscreenapi%2Fapi%2Fextend_screen%2Fv2%2Fhili%2Fclient%2Ftvinfo%2Fharmony"
```
